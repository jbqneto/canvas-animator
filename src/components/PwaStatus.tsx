    ...
    <>
      {installEvent && (
        <button
          ...
          title="Instalar o FlashMotion como aplicativo no computador (abre .fmproj direto do sistema)"
      ...
      {needRefresh && (
        <div className="fixed bottom-3 left-1/2 -translate-x-1/2 z-50 flex items-center gap-3 px-4 py-2 rounded-lg bg-neutral-900 border border-sky-500/50 text-xs text-neutral-200 shadow-xl">
          ...
          {hasUnsavedChanges && <span className="text-amber-300">Salve antes de atualizar.</span>}
          <button
